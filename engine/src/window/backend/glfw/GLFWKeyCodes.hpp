#ifndef GLFW_KEYCODES_HPP
#define GLFW_KEYCODES_HPP
...
const int MOUSE_BUTTON_LAST = GLFW_MOUSE_BUTTON_8;
const int MOUSE_BUTTON_LEFT = GLFW_MOUSE_BUTTON_1;
const int MOUSE_BUTTON_RIGHT = GLFW_MOUSE_BUTTON_2;
